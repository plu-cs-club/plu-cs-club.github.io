        ...
        <div className="space-y-6">
          ...
          >
            ...
            <p className="text-gray-300">
              We meet every{' '}
              <span className="text-[var(--matrix-green)]">Monday</span> at{' '}
              <span className="text-[var(--matrix-green)]">3:45 PM</span> in the
              Morken Center (room 203). All skill levels welcome!
            </p>
          </div>
        </div>
      </div>
